  ...
  en: {
    translation: {
      ...
      about: {
        ...
        history:
          'My journey in web development has been a mix of curiosity, continuous learning, and a strong desire to create digital experiences that truly connect with people. I love working with JavaScript, and thanks to tools like React.js and Next.js, I´ve been able to develop modern, dynamic websites that look great on any screen. I´m in a growth phase, eager to keep learning, take on new challenges, and contribute my part to projects that make a difference.',
        // clients: '1 client',
  ...
  es: {
    translation: {
      ...
      about: {
        ...
        history:
          'Mi camino en el desarrollo web ha sido una mezcla de curiosidad, aprendizaje constante y muchas ganas de crear experiencias digitales que realmente conecten con las personas. Me encanta trabajar con JavaScript y, gracias a herramientas como React.js y Next.js, he podido desarrollar sitios web modernos, dinámicos y que se ven bien en cualquier pantalla. Estoy en una etapa de crecimiento, con muchas ganas de seguir aprendiendo, enfrentar nuevos desafíos y sumar mi granito de arena a proyectos que marquen la diferencia.',
        // clients: '1 Cliente',
